...
extension WorkerSkillCatalog {
    /// Exact agent prompt shipped by metric-space-ai/greppy v0.3.1.
    /// Keep byte-identical to AGENTS.md at tag v0.3.1.
    public static let prescribedGreppyPrompt = #"""
