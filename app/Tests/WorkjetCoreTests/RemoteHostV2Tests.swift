...
"""#
    ...
    func testManagedGreppyArtifactRejectsUnsupportedTargetsAndBadDigest() {
        ...
        XCTAssertTrue(RemotePiBootstrap.hostRuntimeSource.contains("WORKJET_EPHEMERAL_PROVIDER_SOCKET"))
        XCTAssertTrue(RemotePiBootstrap.hostRuntimeSource.contains("credentialSocketPath"))
        XCTAssertFalse(RemotePiBootstrap.hostRuntimeSource.contains("WORKJET_EPHEMERAL_PROVIDER_EXECUTION"))
